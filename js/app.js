...
if (login === "SI") {
    ...
    if (compraBase === "SI") { alert("Su compra total es de $32.000.- Gracias por su compra") }
        ...
        let compraExpa = prompt("Indique que expansion desea escribiendo la letra a la que hace referencia: A. Vientos de Guerra y paz, B. Invasores de tierras lejanas, C. El auge de Fernis").toUpperCase()
        switch (compraExpa) {
            case "A":
        ...
        alert("El libro de Arte de Scythe tiene un precio de $6.000")
